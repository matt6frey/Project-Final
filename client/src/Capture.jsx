...
class Capture extends Component {
  ...
  submitPic = (event) => {
    ...
    // axios.post('http://' + window.location.hostname + ':3001/upload',{
  ...
  //   uploadImage(this.state.imageURL).then(function(result) {
  //     console.log(result);
  //   });
  // }
  }
  ...
  render() {
    return (
      ...
      <p>
        <input type="file" accept="image/*" capture="camera" name='imgFile' onChange={this.showImage} />
      </p>
